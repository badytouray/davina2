...
function Footer() {
  ...
  <div class="row" style={{ textAlign: "center"}}>
    ...
    {/* <!----------- Footer ------------> */}
    <footer class="footer-bs cols-lg-3" style={{ textAlign: "center", backgroundColor: "black"}} >
      <br />
        <div class="row">
    ...
    <section style={{margin: "10px auto"}} class="text-center" ><p>Designed by <a href="http://badytouray.com">badytouray.com</a></p></section>
